...
export const appRoutes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'products/new', canDeactivate: [(page: { canLeave(): boolean }) => page.canLeave()], loadComponent: () => import('./features/catalog/product-editor.page').then((module) => module.ProductEditorPage) },
      { path: 'products/:id', canDeactivate: [(page: { canLeave(): boolean }) => page.canLeave()], loadComponent: () => import('./features/catalog/product-editor.page').then((module) => module.ProductEditorPage) },
      ...
      { path: 'system-health', loadComponent: () => import('./features/reporting/system-health.page').then((module) => module.SystemHealthPage) },
