...
export const appRoutes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'products', loadComponent: () => import('./features/catalog/products.page').then((module) => module.ProductsPage) },
      ...
      { path: 'support', loadComponent: () => import('./features/support/support-inbox.page').then((module) => module.SupportInboxPage) },
      ...
      { path: 'notifications', loadComponent: () => import('./features/notifications/notifications.page').then((module) => module.NotificationsPage) },
      ...
      { path: 'more', loadComponent: () => import('./features/more/more.page').then((module) => module.MorePage) },
    ],
  },
